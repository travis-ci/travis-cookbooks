...
attribute :baseurl, kind_of: String, default: nil
...
attribute :description, kind_of: String, default: 'Ye Ole Rpm Repo'
...
attribute :gpgkey, kind_of: [String, Array], default: nil
attribute :http_caching, kind_of: String, equal_to: %w(packages all none), default: nil
attribute :include_config, kind_of: String, default: nil
...
attribute :mirrorexpire, kind_of: String, default: nil
attribute :mirrorlist, kind_of: String, default: nil
...
attribute :repositoryid, kind_of: String, name_attribute: true
