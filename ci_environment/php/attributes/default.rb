default[:php][:multi][:versions] = ["5.2.17", "5.3.3", "5.3.29", "5.4.37", "5.5.9", "5.5.21", "5.6.5"]
default[:php][:multi][:aliases]  = {"5.2" => "5.2.17", "5.3" => "5.3.29", "5.4" => "5.4.37", "5.5" => "5.5.21", "5.6" => "5.6.5"}
