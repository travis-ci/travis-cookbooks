default[:php][:multi][:versions] = ["5.2.17", "5.3.3", "5.3.27", "5.4.27", "5.5.11", "5.6.0alpha3"]
default[:php][:multi][:aliases]  = {"5.2" => "5.2.17", "5.3" => "5.3.27", "5.4" => "5.4.27", "5.5" => "5.5.11", "5.6" => "5.6.0alpha3"}
