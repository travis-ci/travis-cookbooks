...
export PERL_CPANM_OPT="--notest --mirror 'http://cpan.mirrors.travis-ci.org' --mirror 'http://gd.tuwien.ac.at/languages/perl/CPAN/' --mirror 'http://ftp-stud.hs-esslingen.de/pub/Mirrors/CPAN/'"
