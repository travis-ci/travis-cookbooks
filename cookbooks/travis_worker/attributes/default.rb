...
default['travis_worker']['environment']['TRAVIS_WORKER_WARMED_DOCKER_IMAGES'] = ''
default['travis_worker']['environment']['TRAVIS_WORKER_SELF_IMAGE'] = 'quay.io/travisci/worker:v2.3.1-61-g76a687b'
