...
default['travis_build_environment']['go']['default_version'] = '1.22.5'
default['travis_build_environment']['go']['versions'] = %w(1.22.5)
default['travis_build_environment']['go']['install_user'] = 'travis'
default['travis_build_environment']['go']['install_user_home'] = '/home/travis'
default['travis_build_environment']['go']['debug'] = false
