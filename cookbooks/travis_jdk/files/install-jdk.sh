...
function determine_url() {
    ...
    case "${feature}" in
        8) url="https://download.bell-sw.com/java/8u442+7/bellsoft-jdk8u442+7-linux-amd64.tar.gz"; return;; 
       ...
       11) url="https://download.bell-sw.com/java/11.0.26+9/bellsoft-jdk11.0.26+9-linux-amd64.tar.gz"; return;;
       12) url="${DOWNLOAD}/GA/jdk12.0.2/e482c34c86bd4bf8b56c0b35558996b9/10/GPL/openjdk-12.0.2_${os}-x64_bin.tar.gz"; return;;
       17) url="https://download.bell-sw.com/java/17.0.14+10/bellsoft-jdk17.0.14+10-linux-amd64.tar.gz"; return;;
       21) url="https://download.bell-sw.com/java/21.0.6+10/bellsoft-jdk21.0.6+10-linux-amd64.tar.gz"; return;;
       23) url="https://download.bell-sw.com/java/23.0.2+9/bellsoft-jdk23.0.2+9-linux-amd64.tar.gz"; return;;
    esac
