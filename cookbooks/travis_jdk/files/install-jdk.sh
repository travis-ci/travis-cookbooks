...
function determine_url() {
    ...
    case "${feature}" in
       ...
       11) url="https://download.bell-sw.com/java/11.0.21+10/bellsoft-jdk11.0.21+10-linux-amd64.tar.gz"; return;;
       12) url="${DOWNLOAD}/GA/jdk12.0.2/e482c34c86bd4bf8b56c0b35558996b9/10/GPL/openjdk-12.0.2_${os}-x64_bin.tar.gz"; return;;
       17) url="https://download.bell-sw.com/java/17.0.9+11/bellsoft-jdk17.0.9+11-linux-amd64.tar.gz"; return;;
       21) url="https://download.bell-sw.com/java/21.0.1+12/bellsoft-jdk21.0.1+12-linux-i586.tar.gz"; return;;
    esac
